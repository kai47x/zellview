...
/*
GPDevCompiler.SaveCopyAsText
GPDevCompiler.CompileJava
GPDevCompiler.Run
*/
//package Text;
...
import CP.CmdDialogs.*;

public class Sample2 extends JFrame implements WindowListener, ItemListener, DocumentListener, ActionListener
{

			private  CP.CmdDialogs.CmdDialogs_SuchenUndErsetzen dlg;
			private final String Rsrc = "../Rsrc/";
...
//		this.setIconImage(Toolkit.getDefaultToolkit().getImage(this.getClass().getResource(Rsrc + "Editor.png")));
...
//		icon = new ImageIcon(this.getClass().getResource( Rsrc + "Open.png"));
//		btnDatei = new JButton("Datei öffnen...", icon);
		...
		//icon = new ImageIcon(this.getClass().getResource(Rsrc + "Search.png"));
		...
		//icon = new ImageIcon(this.getClass().getResource( Rsrc + "Exit.png" ) );
...
//			retValue = saveFile();
	...
	{
			//dlg = new CP.CmdDialogs.CmdDialogs_SuchenUndErsetzen();
			dlg = CP.CmdDialogs.CmdDialogs.NewDialog();
			dlg.SetTextArea(textArea);
			dlg.setVisible(true);
		  //dlg.ShowDialog(this);
	}
...

	{
		...
		//BEGIN
			...
			System.out.println("Sample2.main");
			dlg = new Sample2();
			//dlg.setVisible(true);
			dlg.showFrame();
